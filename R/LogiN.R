...
#'
#' A publicly availiable example data set for demonstrating the use of the combiNEM package.
...
#'   ...
#' }
#' @source \url{http://www.holstegelab.nl/publications/sv/signaling_redundancy/}
"combiNEMdata"


###--- MAIN SCRIPT ---###
#' Logic NEMs - main function
...
#' @seealso nem
#' @export
combiNEM <- function(filename="random", method="greedy", nIterations=10, nModels=0,
