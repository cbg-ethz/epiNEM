...
We apply epiNEM so all triples and infer logics and calculate the log-likelihood.
...
We plot the significant results for all triples with log-likelihoods on the y-axis and ranked triples on the x-axis.
...
We apply epiNEM to screen all triples from double and single knock-out combinations.
